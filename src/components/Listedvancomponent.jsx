...
const Listedvancomponent = ({ imageLink, title, price, edit }) => {
    return (
        <div className="listedVanComponent" style={{ background: "#fff", padding: "2rem", borderRadius: "0.4rem"}}>
            <div className="lvc-wrapper" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                <div className="innerLvc" style={{ display: "flex", gap: "1.5rem", alignItems: "center" }}>
                    <img src={imageLink} alt="" style={{ width: "10%", borderRadius: "0.2rem", objectFit: "cover" }} />
                    <div className="lvcText">
