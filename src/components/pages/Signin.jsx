    ...
    return (
        <div style={{ background: "rgba(255, 247, 237, 1)" }}>
            ...
            <div style={{ margin: "0" }}>
                ...
                <p style={{ textAlign: "center", fontSize: "1.1rem", fontWeight: "500", padding: "0 0 4rem" }}>Dont have an account? <span style={{fontSize: "1.1rem", fontWeight: "700", color: "rgba(255, 140, 56, 1)", cursor: "pointer  "}}>Create one now</span></p>
            </div>
